...
const ProductCardCus = props => {
  ...
  return (
    ...
    <Link href="/productscus/${props.id}" target="_blank">
      <a className="border rounded-md p-6 group mt-10">
        {/* Product's image */}
        ...
        <div className="mt-4 flex items-center justify-between space-x-2">
          ...
          <button
            ...
            className={`border rounded-lg py-1 px-4 hover:bg-blue-500 hover:border-rose-500 hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
              adding
