                        ...
                        >
                          <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                            ...
                            <div className="mt-4 grid grid-cols-2">
                              <a
                                type="button"
                                href={`solana:https%3A%2F%2Fmonstre-sp-server.vercel.app%2Fapi%2Fmenu2%3Fmetacamp-menu%3D${encodeURIComponent(
                                  totalPrice
                                )}`}
                              ...
                              <a
                                type="button"
                                href={`solana:https%3A%2F%2Fmonstre-sp-server.vercel.app%2Fapi%2Fmenu1%3Fmetacamp-menu%3D${encodeURIComponent(
                                  totalPrice
                                )}`}
